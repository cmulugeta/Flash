package com.cmulugeta.mediaplayer.data.local
...
import com.cmulugeta.mediaplayer.BuildConfig
import com.cmulugeta.mediaplayer.FakeDataProvider
import com.cmulugeta.mediaplayer.domain.model.Track
import com.cmulugeta.mediaplayer.data.local.MusicDatabase.Tracks
...
class TrackHandlerTest{
    ...
    private fun mockCursor(track: Track): Cursor {
        ...
        whenever(cursor.getString(any<Int>())).thenAnswer({
        ...
        whenever(cursor.getInt(any<Int>())).thenAnswer {
            when(it.arguments[0]){
