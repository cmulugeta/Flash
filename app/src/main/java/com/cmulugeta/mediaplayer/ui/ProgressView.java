package com.cmulugeta.mediaplayer.ui;
...
public class ProgressView extends View {
    ...
    public ProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if(attrs!=null){
            ...
            mStrokeSize=array.getDimension(R.styleable.ProgressView_stroke_width,mStrokeSize);
            mForegroundColor=array.getColor(R.styleable.ProgressView_progress_color, Color.BLUE);
            mBackgroundColor=array.getColor(R.styleable.ProgressView_background_color,Color.WHITE);
            mMax=array.getInteger(R.styleable.ProgressView_progress_max,100);
            mProgress=array.getInteger(R.styleable.ProgressView_current_progress,0);
            mMorph=array.getFloat(R.styleable.ProgressView_morph,0);
            array.recycle();
        }
